...
class NLPProcessor:
    ...
    def process_nlp(self, data, query):
        ...
        try:
            ...
            raise Exception(f"Failed to load model {model_name}. Please check the logs for more details.")
        ...
        try:
            ...
            key_info = self.extract_key_information(response)
            ...
            raise Exception(f"Error during NLP processing: {str(e)}. Please check the logs for more details.")
...
if __name__ == "__main__":
    ...
    result = nlp_processor.process_nlp(test_data, test_query)
    print(result)